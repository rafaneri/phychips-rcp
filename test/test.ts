...
describe('startAutoRead2 function test', () => {
  it('should return BB0036000502000000007E220D', () => {
    ...
    expect(result).to.deep.equal(new Buffer([0xBB, 0x00, 0x36, 0x00, 0x05, 0x02, 0x00, 0x00, 0x00, 0x00, 0x7E, 0x22, 0x0D]));
  });
...
describe('stopAutoRead2 function test', () => {
  it('should return BB003700007EF391', () => {
    ...
    expect(result).to.deep.equal(new Buffer([0xBB, 0x00, 0x37, 0x00, 0x00, 0x7E, 0xF3, 0x91]));
  });
  it('should be a Buffer', () => {
    const result = RCP.stopAutoRead2();
    expect(result).to.be.instanceof(Buffer);
