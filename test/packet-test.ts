...
describe('getEpc function test', () => {
    it('should be 3000e2000016601601551580753d', () => {
        ...
        expect(result.getEpc()).to.deep.equals(Buffer.from([0x30, 0x00, 0xe2, 0x00, 0x00, 0x16, 0x60, 0x16, 0x01, 0x55, 0x15, 0x80, 0x75, 0x3d]));
    });
    it('should be Empty', () => {
